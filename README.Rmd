...
The goal of rpkgjraza is to be provide some helper functions for the care and feeding of factors. 

## Installation

You can install the released version of rpkgjraza from [CRAN](https://CRAN.R-project.org) with:
